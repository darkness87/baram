							...
							<div class="md-layout-item md-medium-size-100">
								...
								<div class="alert alert-info alert-with-icon" data-notify="container">
									...
									<span data-notify="message"
										>This is a notification with close button and icon and have many lines. You can see that the icon and the close button
										are always vertically aligned. This is a beautiful notification. So you don't have to worry about the style.</span
									>
								</div>
							</div>
							<div class="md-layout-item md-medium-size-100">
